...
;(function(window, undefined) {
  ...
  function filter(array, callback, thisArg) {
    ...
    if (callback == 'successful') {
	  ...
	  // //console.log("bench.times.elapsed: " + bench.time.elapsed);
	  
		// return bench.times.elapsed; };
    ...
    function evaluate(event) {
      ...
      if (!done) {
        ...
        if (maxedOut) {
		  ...
		  console.log("times.elapsed: " +times.elapsed);
        }
        if (bench.hz != Infinity) {
		  ...
		  //console.log("bench.count: " +bench.count);
		  //console.log("times.period: " +times.period);
		  //console.log("times.cycle: " +times.cycle);
        }
      }
